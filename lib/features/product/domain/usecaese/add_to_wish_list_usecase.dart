...
class AddToWishListUsecase implements UseCaseWithParams<void, ProductEntity> {
  const AddToWishListUsecase({required this.productRepository});

  final ProductRepository productRepository;

  @override
  ResultFuture<void> call(ProductEntity params) =>
      productRepository.addToWishLists(params);
}
